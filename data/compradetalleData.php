<?php
    ...
    class CompraDetalleData extends Data {
        ...
        public function insertCompraDetalle($compraDetalle, $conn = null) {
            ...
            try {
                ...
                $compraDetalleCantidad = $compraDetalle->getCompraDetalleCantidad();  // Nuevo campo
                ...
                $queryInsert = "INSERT INTO " . TB_COMPRA_DETALLE . " ("
                    ...
                    . COMPRA_DETALLE_CANTIDAD . ", "  // Nuevo campo en la consulta
                ...
                mysqli_stmt_bind_param(
                    $stmt,
                    'iiisssi',  // Agregamos un parámetro adicional de tipo 'i' para la cantidad
                    $nextId,
                    $compraDetalleCompraID,
                    $compraDetalleProductoID,
                    $compraDetalleCantidad,           // Nuevo parámetro
        ...
        public function updateCompraDetalle($compraDetalle) {
            try {
                ...
                mysqli_stmt_bind_param(
                    $stmt,
                    'iiissii', // Tipos de datos ajustados
                    $compraDetalleCompra,
            ...
            try {
                ...
                $querySelect = "
                    SELECT 
                        ...
                        c." . COMPRA_DETALLE_CANTIDAD . ",           // Nuevo campo
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $currentCompraDetalle = new CompraDetalle(
                        ...
                        $row[COMPRA_DETALLE_CANTIDAD],          // Nuevo campo
        ...
        public function getPaginatedCompraDetalles($search, $page, $size, $sort = null) {
            ...
            try {
                ...
                $types = $search ? "ssii" : "iii"; // 'ssii' si se proporciona búsqueda, 'iii' en caso contrario
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    $listaCompraDetalles[] = [
                        ...
                        'Cantidad' => $row[COMPRA_DETALLE_CANTIDAD], // Nuevo campo
    ...
    public function deleteCompraDetalle($compraDetalleID, $conn = null) {
        ...
        try {
            ...
            // Obtener la cantidad del detalle de compra
            $cantidad = $check["cantidad"];
            if ($cantidad <= 0) {
                throw new Exception("No se puede eliminar el detalle de compra porque la cantidad es menor o igual a cero.");
            }
