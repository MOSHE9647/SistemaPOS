<?php
    ...
    class Compra implements JsonSerializable {
        ...
        public function __construct(int $compraID = -1, string $compraNumeroFactura = "", float $compraMontoBruto = 0.0, 
            float $compraMontoNeto = 0.0, string $compraTipoPago = "", Proveedor $compraProveedor = null, $compraFechaCreacion = "", 
            $compraFechaModificacion = "", bool $compraEstado = true) 
        {
        ...
        public function jsonSerialize() {
            return [
                ...
                'Proveedor' => $this->compraProveedor,
