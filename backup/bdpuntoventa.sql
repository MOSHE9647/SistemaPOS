...
-- Tiempo de generación: 01-09-2024 a las 00:31:31
...
CREATE TABLE `tbtipocompra` (
  ...
  `tipocompradescripcion` text,
  `tipocompranombre` varchar(100) NOT NULL,
  `tipocompratasainteres` decimal(10,2) NOT NULL,
  `tipocompraplazos` int NOT NULL,
  `tipocomprameses` int NOT NULL,
  `tipocomprafechacreacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `tipocomprafechamodificacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
