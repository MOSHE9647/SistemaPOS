...
<div class="page-header">
    <div class="page-title">
        <h1>Administraci&oacute;n de <span>Clientes</span>:</h1>
        ...
        <div class="table-container">
            <div class="table-header">
                ...
                <div class="search-bar">
                    <input type="text" id="cliente-search-input" placeholder="Buscar por nombre, alias o teléfono">
                    <button class="search-button" id="cliente-search-button" onclick="pagination.searchClientes()">
