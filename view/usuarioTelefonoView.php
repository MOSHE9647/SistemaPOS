...
<html lang="es-cr">
    <head>
        ...
        <title>Gestión de Teléfonos de Usuarios | POSFusion</title>
    ...
    <body>
        <h2>Lista de Teléfonos según Usuario</h2>

        <div id="message"></div>

        <div class="usuarios-container">
            <label for="usuario-select">Seleccione un Usuario:</label>
            <select id="usuario-select" onchange="loadTelefonos()">
        ...
        <script>
            function loadTelefonos() {
                ...
                if (table) {
                    ...
                    cancelCreate();
                    cancelEdit();
                    fetchTelefonos(usuario, currentPage, pageSize, sort);
                } else {
        ...
        <script src="./js/usuarioTelefono/gui.js"></script>
        <script src="./js/usuarioTelefono/selects.js"></script>
        <script src="./js/usuarioTelefono/pagination.js"></script>
        <script src="./js/usuarioTelefono/crud.js"></script>
    </body>
</html>
