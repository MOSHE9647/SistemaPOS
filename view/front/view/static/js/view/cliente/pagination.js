 ...
 * 
 * @example
 * fetchClientes(1, 10, 'tipo');
 * 
 * @returns {void}
 */
export function fetchClientes(page, size, sort) {
    // Realizar solicitud GET al servidor para obtener la lista de clientes
    fetch(`../../../../../../controller/clienteAction.php?page=${page}&size=${size}&sort=${sort}`)
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                // Actualizar contclientes de paginación
...
export function changePage(newPage) {
    ...
    if (newPage >= 1 && newPage <= window.totalPages) {
        ...
        fetchClientes(newPage, window.pageSize, window.sort);
    }
}
