 ...
 * @returns {void}
 */
function fetchSubcategorias(page, size, sort) {
    // Realizar solicitud GET al servidor para obtener la lista de subcategorias
    fetch(`../controller/subcategoriaAction.php?page=${page}&size=${size}&sort=${sort}`)
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                // Actualizar contsubcategorias de paginación
...
/**
 * Actualiza los contsubcategorias de paginación en la página.
 * 
...
function changePage(newPage) {
    ...
    if (newPage >= 1 && newPage <= totalPages) {
        ...
        fetchSubcategorias(newPage, pageSize, sort);
    }
}
