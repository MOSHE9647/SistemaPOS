 ...
 * 
 * @example
 * fetchRoles(1, 10, 'tipo');
 * 
 * @returns {void}
 */
function fetchRoles(page, size, sort) {
    // Realizar solicitud GET al servidor para obtener la lista de roles
    fetch(`../controller/rolUsuarioAction.php?page=${page}&size=${size}&sort=${sort}`)
...
function changePage(newPage) {
    ...
    if (newPage >= 1 && newPage <= totalPages) {
        ...
        fetchRoles(newPage, pageSize, sort);
    }
}
