        ...
        let row = `
            <tr data-id="${telefono.ID}">
                ...
                <td>
                    ...
                    <button onclick="removeTelefonoFromProveedor(${telefono.ID})">Eliminar</button>
                </td>
            </tr>
        `;
...
function showCreateRow() {
    ...
    newRow.innerHTML = `
        ...
        <td>
            <button onclick="addTelefonoToProveedor()">Crear</button>
...
function cancelEdit() {
    ...
    if (cancelBtn) { fetchTelefonos(proveedor, currentPage, pageSize, sort); }
}
