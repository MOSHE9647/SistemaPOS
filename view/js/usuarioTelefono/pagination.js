 ...
 * @returns {void}
 */
function fetchTelefonos(usuarioID, page, size, sort) {
    // Realizar solicitud GET al servidor para obtener la lista de telefonos
    fetch(`../controller/usuarioTelefonoAction.php?page=${page}&size=${size}&sort=${sort}&usuario=${usuarioID}`)
...
function changePage(newPage) {
    ...
    if (newPage >= 1 && newPage <= totalPages) {
        ...
        fetchTelefonos(usuario, newPage, pageSize, sort);
    }
}
