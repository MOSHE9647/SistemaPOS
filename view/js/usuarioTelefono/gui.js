        ...
        let row = `
            <tr data-id="${telefono.ID}">
                ...
                <td>
                    ...
                    <button onclick="removeTelefonoFromUsuario(${telefono.ID})">Eliminar</button>
                </td>
            </tr>
        `;
...
function showCreateRow() {
    ...
    newRow.innerHTML = `
        ...
        <td>
            <button onclick="addTelefonoToUsuario()">Crear</button>
...
function cancelEdit() {
    ...
    if (cancelBtn) { fetchTelefonos(usuario, currentPage, pageSize, sort); }
}
