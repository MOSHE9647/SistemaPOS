...
<head>
    ...
    <title>Gestión de Presentaciones | POSFusion</title>
...
<body>
    ...
    <div class="table-container">
        <div class="table-header">
            ...
            <!-- Botón para crear nueva Presentación -->
    ...
    <script src="./js/presentacion/gui.js"></script>
    <script src="./js/presentacion/pagination.js"></script>
    <script src="./js/presentacion/crud.js"></script>
</body>
</html>
