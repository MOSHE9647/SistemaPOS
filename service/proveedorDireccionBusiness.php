<?php
	...
	class ProveedorDireccionBusiness {
            ...
            try {
                ...
                if ($both || $direccionID !== null) {
                    if (!is_numeric($direccionID) || $direccionID <= 0) {
                        ...
                        Utils::writeLog("El ID [$direccionID] del teléfono no es válido.", BUSINESS_LOG_FILE, ERROR_MESSAGE, $this->className);
                    }
                }
		...
		public function getPaginatedTelefonosByProveedor($proveedorID, $page, $size, $sort = null, $onlyActiveOrInactive = true, $deleted = false) {
			...
			return $this->proveedorDireccionData->getPaginatedTelefonosByProveedor($proveedorID, $page, $size, $sort, $onlyActiveOrInactive, $deleted);
		}
